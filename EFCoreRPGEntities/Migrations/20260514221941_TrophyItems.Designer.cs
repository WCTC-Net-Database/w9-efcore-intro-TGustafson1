...
namespace EFCoreRPGEntities.Migrations
{
    ...
    [Migration("20260514221941_TrophyItems")]
    partial class TrophyItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreRPGEntities.Models.Door", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("RequiredKeyItemId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCoreRPGEntities.Models.Items.KeyItem", b =>
                {
                    b.HasBaseType("EFCoreRPGEntities.Models.Items.Item");
            ...
            modelBuilder.Entity("EFCoreRPGEntities.Models.Items.TrophyItem", b =>
                {
                    b.HasBaseType("EFCoreRPGEntities.Models.Items.Item");

                    b.HasDiscriminator().HasValue("TrophyItem");
                });
            ...
            modelBuilder.Entity("EFCoreRPGEntities.Models.Containers.Container", b =>
                {
                    b.HasOne("EFCoreRPGEntities.Models.Containers.Container", "ParentContainer")
            ...
            modelBuilder.Entity("EFCoreRPGEntities.Models.Door", b =>
                {
                    b.HasOne("EFCoreRPGEntities.Models.Room", "RoomA")
                        .WithMany()
                        .HasForeignKey("RoomAId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EFCoreRPGEntities.Models.Room", "RoomB")
                        .WithMany()
