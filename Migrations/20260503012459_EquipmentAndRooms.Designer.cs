...
namespace W09.Migrations
{
    ...
    [Migration("20260503012459_EquipmentAndRooms")]
    partial class EquipmentAndRooms
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("W09.Models.Items.Equipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("W09.Models.Items.Item", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("W09.Models.Items.Equipment", b =>
                {
                    b.HasOne("W09.Models.Items.Item", "Armor")
                        .WithMany()
                        .HasForeignKey("ArmorId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("W09.Models.Items.Item", "Weapon")
                        .WithMany()
            ...
            modelBuilder.Entity("W09.Models.Room", b =>
                {
                    b.HasOne("W09.Models.Room", "EastRoom")
                        .WithMany()
                        .HasForeignKey("EastRoomId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("W09.Models.Room", "NorthRoom")
                        .WithOne()
                        .HasForeignKey("W09.Models.Room", "NorthRoomId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("W09.Models.Room", "SouthRoom")
                        .WithOne()
                        .HasForeignKey("W09.Models.Room", "SouthRoomId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("W09.Models.Room", "WestRoom")
                        .WithMany()
            ...
            modelBuilder.Entity("W09.Models.Player", b =>
                {
                    b.HasOne("W09.Models.Items.Equipment", "Equipment")
                        .WithOne("Player")
                        .HasForeignKey("W09.Models.Player", "EquipmentId");
